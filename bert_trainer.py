...
if __name__ == '__main__':
	from corpus_dataset import PureGenDataset, RoBERTaFullSent, MixedSentences, RoBERTaFullSentFast
	bsz = 64
	ds = PureGenDataset(RoBERTaFullSentFast(MixedSentences(), tokenizer, maxlen, repeat=3), bsz*100000)
